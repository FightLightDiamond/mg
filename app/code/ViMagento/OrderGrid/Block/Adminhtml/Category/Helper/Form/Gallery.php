...
namespace ViMagento\OrderGrid\Block\Adminhtml\Category\Helper\Form;
...
class Gallery extends \Magento\Framework\View\Element\AbstractBlock
{
     ...
     * @var string
     */
    protected $fieldNameSuffix = 'category';
     ...
     * @var string
     */
    protected $name = 'category[media_gallery]';
...
//            if ($images === null) {
//                $images = ((array)$this->dataPersistor->get('catalog_category'))['category']['media_gallery'] ?? null;
//            }
//
//            return $images;
...
//        }
    ...
    {
        $category = (array)$this->dataPersistor->get('catalog_category');
