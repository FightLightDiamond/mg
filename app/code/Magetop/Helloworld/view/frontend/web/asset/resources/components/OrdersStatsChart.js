...
export default class OrdersStatsChart extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentWillReceiveProps(props, state) {
        const data = props.report_orders_stats.intervals;
        let chartData = [];
        let tableData = [];
    ...
    getData() {
        const { getReportsOrdersStats } = this.props
        const params = {
            '_locale': 'user',
    ...
    render() {
        const data = repostProductsTransformer('Order Stat Chart', this.state.chartData);
